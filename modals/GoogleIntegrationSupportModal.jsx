        ...
        <DialogHeader>
          <div className="flex justify-center mb-4">
              <div className="p-3 bg-gradient-to-br from-blue-400 to-sky-500 rounded-full inline-block">
                <img src="https://storage.googleapis.com/hostinger-horizons-assets-prod/570c4741-c1bd-4db7-94d5-630722156b43/b0cf3e78e47012574e4a838522300b91.png" alt="Google Calendar Icon" className="w-8 h-8" />
              </div>
          </div>
